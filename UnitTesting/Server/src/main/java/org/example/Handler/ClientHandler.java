...
public class ClientHandler extends Thread {
    ...
    public void run() {
        ...
        try (BufferedReader in = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()))) {
            ...
            ProtocolHandler protocolHandler = createProtocolHandler(out, in);
            while (true) {
    ...
    protected ProtocolHandler createProtocolHandler(PrintWriter out, BufferedReader in) {
        return new ProtocolHandler(out, in);
    }
    ...
    boolean isValidSession(RequestData requestData){
